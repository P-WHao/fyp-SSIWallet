...
import LoginRegisterChoice from '../screens/LoginRegisterChoice'
import LoginRegisterChoiceRegister from '../screens/LoginRegisterChoiceRegister'
  ...
  const authStack = () => {
    ...
    return (
      <Stack.Navigator initialRouteName={Screens.Splash} screenOptions={{ ...defaultStackOptions, headerShown: false }}>
        ...
        ></Stack.Screen>
        <Stack.Screen
          name={Screens.LoginRegisterChoice}
          component={LoginRegisterChoice}
          options={{ headerShown: false, headerLeft: () => null }}
        ></Stack.Screen>
        <Stack.Screen
          name={Screens.LoginRegisterChoiceRegister}
          component={LoginRegisterChoiceRegister}
          options={{ headerShown: false, headerLeft: () => null }}
        ></Stack.Screen>
      </Stack.Navigator>
    )
