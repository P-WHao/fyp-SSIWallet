...
import { useWindowDimensions, Vibration, View, StyleSheet, Text, Linking } from 'react-native'
...
const QRScanner: React.FC<Props> = ({ handleCodeScan, error, enableCameraOnError }) => {
  ...
  const { ColorPallet, TextTheme, HomeChatTheme} = useTheme()
        ...
        <CameraViewContainer portrait={portraitMode}>
          ...
          <View style={styles.viewFinderContainer}>
            <View style={styles.viewFinder} />
              <View style={styles.needHelpBack}>
                <View style={HomeChatTheme.scanText}><Text>{t('ScanQr.PlaceCodeInsideBox')}</Text></View>
              </View>
              <View style={styles.needHelpBack1}>
                <View>
                  <Text style={HomeChatTheme.scanText} onPress={() => {
