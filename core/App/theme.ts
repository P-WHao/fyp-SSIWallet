...
const BrandColors: BrandColors = {
  primary: '#25ABE2',
  primaryDisabled: `rgba(37, 171, 226, ${lightOpacity})`,
  secondary: '#FFFFFFFF',
  secondaryChat: '#25ABE2',
  secondaryDisabled: `rgba(37, 171, 226, ${heavyOpacity})`,
  highlight: '#FCBA19',
...
export const ChatTheme = {
  ...
  leftText: {
    color: ColorPallet.brand.secondaryChat,
...
export const Assets = {
  ...
  img: {
    ...
    logoPrimary: {
      src: require('./assets/img/ic_launcher.png'),
      height: 120,
      width: 120,
      //aspectRatio: 1,
      // height: '33%',
