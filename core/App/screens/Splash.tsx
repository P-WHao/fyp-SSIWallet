...
const Splash: React.FC = () => {
  const image = { uri: "https://st3.depositphotos.com/1679906/16184/v/450/depositphotos_161845848-stock-illustration-abstract-polygonal-background-texture-vertical.jpg" };
      ...
      try {
        ...
        if (data) {
          ...
          if (onboardingComplete(onboardingState) && !attemptData?.lockoutDate) {
            navigation.navigate(Screens.LoginRegisterChoice as never) //EnterPin
            return
        ...
        navigation.navigate(Screens.LoginRegisterChoiceRegister as never)  //Onboarding
      } catch (error) {
        //
      }
    }
